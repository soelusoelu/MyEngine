...
namespace MyFilter {
LowPassOnePoleFilter::LowPassOnePoleFilter() :
...
LowPassOnePoleFilter::~LowPassOnePoleFilter() = default;

STDMETHODIMP_(HRESULT __stdcall) LowPassOnePoleFilter::LockForProcess(UINT32 InputLockedParameterCount, const XAPO_LOCKFORPROCESS_BUFFER_PARAMETERS* pInputLockedParameters, UINT32 OutputLockedParameterCount, const XAPO_LOCKFORPROCESS_BUFFER_PARAMETERS* pOutputLockedParameters) {
...
STDMETHODIMP_(void __stdcall) LowPassOnePoleFilter::Process(UINT32 InputProcessParameterCount, const XAPO_PROCESS_BUFFER_PARAMETERS* pInputProcessParameters, UINT32 OutputProcessParameterCount, XAPO_PROCESS_BUFFER_PARAMETERS* pOutputProcessParameters, BOOL IsEnabled) {
...
STDMETHODIMP_(void __stdcall) LowPassOnePoleFilter::SetParameters(const void* pParameters, UINT32 ParameterByteSize) {
...
void LowPassOnePoleFilter::lowPassOnePoleFilter(const XAPO_PROCESS_BUFFER_PARAMETERS& inParam, XAPO_PROCESS_BUFFER_PARAMETERS& outParam) {
    //サイレントなら計算はしない
